    ...
    <div class="starter-template">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/iphone_x.jpg" alt="iPhone X 64GB">
                    <div class="caption">
                        <h3>iPhone X 64GB</h3>
                        <p>71990 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/iphone_x_256.jpg" alt="iPhone X 256GB">
                    <div class="caption">
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/htc.jpg" alt="HTC One S">
                    <div class="caption">
                        <h3>HTC One S</h3>
                        <p>12490 руб.</p>
                        <p>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/iphone_5s.jpg" alt="iPhone 5SE">
                    <div class="caption">
                        <h3>iPhone 5SE</h3>
                        <p>17221 руб.</p>
                        <p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/beats.png" alt="Наушники Beats Audio">
                    <div class="caption">
                        <h3>Наушники Beats Audio</h3>
                        <p>20221 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/5/add" class="btn btn-primary"
                               role="button">В корзину</a>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/gopro.jpg" alt="Камера GoPro">
                    <div class="caption">
                        <h3>Камера GoPro</h3>
                        <p>12000 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/6/add" class="btn btn-primary"
                               role="button">В корзину</a>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/panasonic.jpg" alt="Камера Panasonic HC-V770">
                    <div class="caption">
                        <h3>Камера Panasonic HC-V770</h3>
                        <p>27900 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/7/add" class="btn btn-primary"
                               role="button">В корзину</a>
                            <a href="http://laravel-diplom-1.rdavydov.ru/portable/panasonic_hc-v770"
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/DeLongi.jpg" alt="Кофемашина DeLongi">
                    <div class="caption">
                        <h3>Кофемашина DeLongi</h3>
                        <p>25200 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/8/add" class="btn btn-primary"
                               role="button">В корзину</a>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/Haier.jpg" alt="Холодильник Haier">
                    <div class="caption">
                        <h3>Холодильник Haier</h3>
                        <p>40200 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/9/add" class="btn btn-primary"
                               role="button">В корзину</a>
        ...
        <div class="row">
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/Moulinex.jpeg" alt="Блендер Moulinex">
                    <div class="caption">
                        <h3>Блендер Moulinex</h3>
                        <p>4200 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/10/add" class="btn btn-primary"
                               role="button">В корзину</a>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    <img src="/images/Bosch.jpg" alt="Мясорубка Bosch">
                    <div class="caption">
                        <h3>Мясорубка Bosch</h3>
                        <p>9200 руб.</p>
                        <p>
                            <a href="http://laravel-diplom-1.rdavydov.ru/basket/11/add" class="btn btn-primary"
                               role="button">В корзину</a>
